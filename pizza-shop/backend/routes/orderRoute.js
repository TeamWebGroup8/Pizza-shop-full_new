...
const stripe = require("stripe")(
  "sk_test_51McLASGaxSNqxYHHr42lUWUTjJYBkOVjwEHmfEODtrUSu2qsZ5wfBNLUNpVJL0HYaJfgHBs7prCDmSjIB5c8Q9l600SNWUtsOM"
);
const Order = require("../models/orderModel");

router.post("/placeorder", async (req, res) => {
  const { token, subTotal, currentUser, cartItemsFromStorage } = req.body;
  try {
